...
@Component({
  selector: 'app-feedthrough-cz',
  templateUrl: './feedthrough-cz.component.html',
  styleUrls: ['./feedthrough-cz.component.css']
})
export class FeedthroughCzComponent implements OnInit {
