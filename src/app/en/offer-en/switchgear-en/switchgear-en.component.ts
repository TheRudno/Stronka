...
@Component({
  selector: 'app-switchgear-en',
  templateUrl: './switchgear-en.component.html',
  styleUrls: ['./switchgear-en.component.css']
})
export class SwitchgearEnComponent implements OnInit {
